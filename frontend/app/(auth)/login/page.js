    ...
    <div className='min-h-screen flex justify-center items-center bg-gray-200'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-8' >
            ...
            <div className=" flex flex-col  ">
                ...
                <button  type="submit" className='bg-blue-950 text-white p-3 text-xl rounded-xl font-medium border-2 border-blue-950 cursor-pointer hover:text-blue-950 hover:bg-white hover:border-2 hover:border-blue-950 hover:transition-all duration-300'>Login</button>
            ...
            <div className="flex justify-center items-center ">
                <span className='text-base '>Don't have an accout ? <Link href="/signup" className="font-semibold text-blue-950 border-b cursor-pointer">Register</Link> </span>
            </div>
        </div>
